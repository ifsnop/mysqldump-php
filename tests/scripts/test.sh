...
checksum_test001 > output/test001.src.checksum
checksum_test002 > output/test002.src.checksum
checksum_test005 > output/test005.src.checksum
$MYSQLDUMP_CMD test001 \
    --no-autocommit \
    --skip-extended-insert \
    --hex-blob \
    --routines \
    > output/mysqldump_test001.sql
...
$MYSQLDUMP_CMD test001 \
    ...
    --hex-blob \
    --routines \
    > output/mysqldump_test001_complete.sql
errCode=$?; ret[((index++))]=$errCode
...
$MYSQLDUMP_CMD test001 \
    ...
    --hex-blob \
    --insert-ignore \
    > output/mysqldump_test013.sql
errCode=$?; ret[((index++))]=$errCode

php test.php || { echo "ERROR running test.php" && exit -1; }
errCode=$?; ret[((index++))]=$errCode

$MYSQL_CMD test001 < output/mysqldump-php_test001.sql
errCode=$?; ret[((index++))]=$errCode
$MYSQL_CMD test002 < output/mysqldump-php_test002.sql
errCode=$?; ret[((index++))]=$errCode
$MYSQL_CMD test005 < output/mysqldump-php_test005.sql
errCode=$?; ret[((index++))]=$errCode
$MYSQL_CMD test006b < output/mysqldump-php_test006.sql
errCode=$?; ret[((index++))]=$errCode
$MYSQL_CMD test009 < output/mysqldump-php_test009.sql
errCode=$?; ret[((index++))]=$errCode

checksum_test001 > output/mysqldump-php_test001.checksum
checksum_test002 > output/mysqldump-php_test002.checksum
checksum_test005 > output/mysqldump-php_test005.checksum

cat test001.src.sql | grep ^INSERT > output/test001.filtered.sql
cat test002.src.sql | grep ^INSERT > output/test002.filtered.sql
cat test005.src.sql | grep ^INSERT > output/test005.filtered.sql
cat test008.src.sql | grep FOREIGN > output/test008.filtered.sql
cat test010.src.sql | grep CREATE | grep EVENT > output/test010.filtered.sql

if [[ $major -eq 5 && $medium -ge 7 ]]; then
    # test virtual column support, with simple inserts forced to complete (a) and complete inserts (b)
    cat test011.src.sql | egrep "INSERT|GENERATED" > output/test011.filtered.sql
else
    echo "test011 disabled, only valid for mysql server version > 5.7.0"
fi

cat output/mysqldump_test001.sql | grep ^INSERT > output/mysqldump_test001.filtered.sql
cat output/mysqldump_test001_complete.sql | grep ^INSERT > output/mysqldump_test001_complete.filtered.sql
cat output/mysqldump_test002.sql | grep ^INSERT > output/mysqldump_test002.filtered.sql
cat output/mysqldump_test005.sql | grep ^INSERT > output/mysqldump_test005.filtered.sql
cat output/mysqldump_test012.sql | grep -E -e '50001 (CREATE|VIEW)' -e '50013 DEFINER' -e 'TRIGGER' -e 'FUNCTION' -e 'PROCEDURE' | grep -v -e 'TABLE' -e 'CREATE VIEW' > output/mysqldump_test012.filtered.sql
cat output/mysqldump_test013.sql | grep "INSERT" > output/mysqldump_test013.filtered.sql
cat output/mysqldump-php_test001.sql | grep ^INSERT > output/mysqldump-php_test001.filtered.sql
cat output/mysqldump-php_test001_complete.sql | grep ^INSERT > output/mysqldump-php_test001_complete.filtered.sql
cat output/mysqldump-php_test002.sql | grep ^INSERT > output/mysqldump-php_test002.filtered.sql
cat output/mysqldump-php_test005.sql | grep ^INSERT > output/mysqldump-php_test005.filtered.sql
cat output/mysqldump-php_test008.sql | grep FOREIGN > output/mysqldump-php_test008.filtered.sql
cat output/mysqldump-php_test010.sql | grep CREATE | grep EVENT > output/mysqldump-php_test010.filtered.sql

if [[ $major -eq 5 && $medium -ge 7 ]]; then
    # test virtual column support, with simple inserts forced to complete (a) and complete inserts (b)
    cat output/mysqldump-php_test011a.sql | egrep "INSERT|GENERATED" > output/mysqldump-php_test011a.filtered.sql
    cat output/mysqldump-php_test011b.sql | egrep "INSERT|GENERATED" > output/mysqldump-php_test011b.filtered.sql
else
    echo "test011 disabled, only valid for mysql server version > 5.7.0"
fi

cat output/mysqldump-php_test012.sql | grep -E -e '50001 (CREATE|VIEW)' -e '50013 DEFINER' -e 'CREATE.*TRIGGER' -e 'FUNCTION' -e 'PROCEDURE' > output/mysqldump-php_test012.filtered.sql
cat output/mysqldump-php_test013.sql | grep INSERT > output/mysqldump-php_test013.filtered.sql
